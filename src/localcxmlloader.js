...
//CXML loader
PivotViewer.Models.Loaders.LocalCXMLLoader = PivotViewer.Models.Loaders.ICollectionLoader.subClass({
    init: function (CXMLFile) {
    ...
    LoadCollection: function (collection) {
        ...
        reader.onload = function () {
            var xml = $.parseXML(reader.result), $xml = $(xml);
        ...
        reader.readAsText(this.CXMLFile);
    }
});
